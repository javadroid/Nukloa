...
export class AppComponent {
  ...
  showChat = false
  faCoffee = faCoffee;
  chatInput = 'What is $NUKN NUKLEON DECENTRALIZED ORBITAL'
  conversations = [] as any[]
  backgroudimage = ['5', '18', '42', '46', '49', '52', '57', '154', '33']
  createChatCompletion = [{ role: "assistant", content: 'Nukleon Decentralized Orbital (NUKN) is a cryptocurrency project that aims to create a decentralized exchange platform for trading digital assets. The platform is built on the Ethereum blockchain and uses smart contracts to execute trades automatically without the need for intermediaries. NUKN token is the native cryptocurrency of the platform and is used to pay for transaction fees and other services. The project aims to provide users with a secure and transparent platform for trading digital assets while maintaining their privacy and security.' },
  { role: "assistant", content: '$NUKN is currently on presale and not trading' },
  { role: "assistant", content: '$NUKN offical site is http://nukleon.io' }] as any[]
  ngOnInit(): void {
